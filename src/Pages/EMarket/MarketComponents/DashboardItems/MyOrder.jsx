  ...
  return (
    <div className="mt-[80px] mb-36 md:mb-24">
     ...
     {orders.map((order) => (
        <div
          key={order}
          className="px-6 py-2 shadow-2xl rounded-xl  md:mx-24 mt-6"
        >
          <div className="w-full border-b-2 border-gray-900">
            <h6>Order id: <span className='text-red-600'>#8745867gkjh</span></h6>
          ...
          <div className="flex items-start justify-around px-6 py-2">
            ...
            <p className="text-sm md:text-base mx-2 px-2  md:px-4 md:py-1 rounded-full text-white bg-blue-500">Stutus</p>
