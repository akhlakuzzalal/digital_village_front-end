  ...
  return (
    <div className="mt-[80px] mb-36 md:mb-24">
     ...
     {orders.map((order) => (
        <div
          key={order}
          className=" py-2 shadow-2xl rounded-xl mx-auto ml-6  md:mx-24 mt-6"
        >
          <div className="w-full border-b-2 border-gray-900">
            <h6 className='text-sm md:text-base'>Order id: <span className='text-red-600 '>#8745867gkjh</span></h6>
            <p>Order placed on <span className='text-blue-600'>12/02/2022</span></p>
          </div>
          <div className="flex items-start justify-around py-2">
            ...
            <p className="text-sm md:text-base    md:px-4 md:py-1 rounded-full text-white bg-blue-500">Stutus</p>
            <p className='text-sm md:text-xl'>Delevered: <span className='text-red-600'>15/01/2022</span></p>
          </div>
        </div>
      ))}
