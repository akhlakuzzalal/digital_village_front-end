    ...
    style={{
      ...
      <form onSubmit={handleSubmit(handlePublishNews)} className="space-y-6 px-4">
        <div className="flex flex-wrap gap-4 items-center justify-evenly">
          {/* title of the News */}
          <input
            className="md:px-7 mx-2 py-8 bg-gray-100 outline-none border-2 focus:border-primary w-full transition-all duration-300 rounded-xl"
          ...
          {/* about the News */}
          <textarea
            className="px-7 py-8 bg-gray-100 outline-none border-2 focus:border-primary w-full transition-all duration-300 rounded-xl"
        ...
        <RichTextEditor
          className="px-4 py-8 bg-gray-100 outline-none border-2 focus:border-primary w-full transition-all duration-300 rounded-xl"
