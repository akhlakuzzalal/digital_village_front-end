...
const HelpRequestApply = () => {
    ...
    return (
        ...
        style={{ minHeight: 'calc(100vh - 700px)' }}>
             <h3 className="text-center font-semibold text-gray-800 text-lg md:text-2xl lg:text-3xl mx-auto ml-16">Help Request Apply</h3>
...
export default HelpRequestApply;