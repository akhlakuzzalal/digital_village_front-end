...
const AllApply = () => {
    ...
    return (
        ...
        <h3 className="text-center text-gray-800 text-sm md:text-lg lg:text-2xl">All User Apply</h3>
        ...
        <div className="rounded-lg">
            ...
            <tbody>
                <tr className="bg-white border-b font-primary text-sm grid grid-cols-1 lg:grid-cols-6 place-items-center">
                    ...
                    shorifzaman
                    <td className="text-sm text-gray-600 py-2whitespace-nowrap">zaman@amin.com</td>
                    </td>
                    ...
                    <td className="text-sm text-gray-600 px-6 py-4 whitespace-nowrap">sylhet,bangladesh
                    <td className="text-sm text-gray-500 py-2 whitespace-nowrap">Mon Mar 14 2022
                    </td>
                    </td>
