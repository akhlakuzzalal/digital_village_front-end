...
const ManageEvents = () => {
  ...
  return (
    <div>
      <h1 className="flex space-x-3 text-xl ml-5 mt-10 mx-auto">
        Delete Exixting Events{' '}
        <AiFillDelete color="red" className="animate-bounce mt-2" />
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 lg-gap-5 md:gap-4 py-20 lg:mx-[150px] mx-5">
        {allEvent.map((event) => (
          <ManageEventsCard
            key={event._id}
            event={event}
