...
const Step3 = () => {
  ...
  return (
    <div className="w-full md:w-1/2 border-1 rounded-lg ">
      <div className=" grid grid-cols-1 md:grid-cols-2 justify-center items-center py-2 px-2 md:px-10 ">
        ...
        <div className=" flex flex-col  justify-start items-start    text-left py-16 ">
          ...
          <h6 className=" text-start text-sm text-blue-700">Confirm Booking</h6>
    ...
    // <div className=" w-full md:w-1/2 border-1 rounded-lg bg-orange-200">
    //   <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center py-2 px-2 md:px-10 ">
    //     {/* banner description */}
    //     <div className=" flex flex-col  justify-center items-start   order-2 md:order-1 text-left  my-16 mx-16 ">
    //       <h3 className="text-start text-lg md:text-2xl ">
    //         Step <span className=" text-xl md:text-4xl text-blue-700">4</span>
    //       </h3>
