...
const Contact = () => {
  ...
  return (
    <div className="mt-[88px]" style={{ minHeight: 'calc(100vh - 700px)' }}>
      ...
      >
        <h1 className="text-5xl text-center text-white pt-16 font-bold">
          Contact With Us
        </h1>
        <h3 className="text-center font-semibold my-3 text-2xl text-white ">
          Home / Contact Us
        </h3>
      </div>
      <div className="pr-8">
        <h3 className="text-center text-2xl font-semibold mt-16 mb-3 text-gray-500">
          FOLLOW OUR INFO
        </h3>
        <h1 className="text-5xl text-center font-bold">Contact information</h1>
        <h4 className="text-center mt-5  mx-10 container text-1xl font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mt-10 Container">
        ...
        <div className="flex flex-col items-center bg-white rounded-lg  md:flex-row      container md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          <div className="flex flex-col justify-between p-4 leading-normal">
            <h3 className="mb-3  text-gray-700 dark:text-gray-400 text-3xl font-bold">
              Our Socials Links
            </h3>
            <p className="mb-3 font-semibold text-gray-700 dark:text-gray-400">
            ...
            <div className="inline-grid grid-cols-6">
              <img
                className=" d-flex object-cover rounded-full h-10 w-10 m-2"
              ...
              />
              <img
                className="object-cover rounded-full h-10 w-10 m-2"
      ...
      <div className="mt-10">
        ...
        <h1 className="text-5xl text-center font-bold">Now Very Easy</h1>
