...
const BlogCard = ({ blog }) => {
  ...
  return (
    <div className="bg-white dark:dark-card-bg rounded-xl px-10 md:p-4 box-border overflow-hidden relative flex flex-col justify-between max-w-[400px] shadow-2xl">
      {/* image  */}
      <div
