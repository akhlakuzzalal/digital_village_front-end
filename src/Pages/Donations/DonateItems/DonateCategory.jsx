...
import { FaBookReader, FaHandHoldingWater, FaHandsHelping, FaHospital } from 'react-icons/fa';
...
const DonateCategory = () => {
    return (
        <div className="mx-auto px-4 sm:px-6">
          ...
          <h3 className="animate-bounce text-green-500">ACHIEVED WITH YOU</h3>
          <p>We need your help</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full bg-white p-4">
        <div class="p-6 md:p-10 rounded-xl bg-blue-50 overflow-hidden shadow hover:shadow-md">
