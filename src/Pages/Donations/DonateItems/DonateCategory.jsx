...
const DonateCategory = () => {
  return (
    <div className="mx-auto px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full bg-white p-4">
        <div className="p-6 md:p-10 rounded-xl bg-blue-50 overflow-hidden shadow hover:shadow-md">
