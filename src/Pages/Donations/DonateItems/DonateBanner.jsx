...
const DonateBanner = () => {
  ...
  const defaultOptions = {
    ...
    return (
        <div
            className="mt-[88px] bg-gray-700  bg-no-repeat bg-cover bg-center px-10 object-fill"
            style={{ 
            height: 'calc(100vh - 88px)',
           backgroundImage: 'url(http://nasarna-react.wpocean.com/static/media/img-1.c4e303eb.jpg)'}}
        >
