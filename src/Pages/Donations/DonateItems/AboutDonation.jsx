...
<h3 className="text-gray-800 text-center text-sm md:text-2xl lg:text-3xl mt-2">ACHIEVED WITH YOU</h3>
        <p className="text-gray-600 text-center text-sm md:text-xl lg:text-2xl mt-2 py-6">About Us</p>
  <div class="flex flex-wrap items-center">
    <div class="w-full lg:w-2/5 md:w-1/2 px-8 md:px-4 mr-auto ml-auto -mt-78">
      <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-green-500 bg-gradient-to-r from-lime-300 bg-gradient-to-t from-blue-300 to-green-600">
        <img src="http://nasarna-react.wpocean.com/static/media/about3.9af31693.png" class="w-full align-middle rounded-t-lg"  alt="donatabout"  />
        <blockquote class="relative p-8 mb-4">
          ...
          There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there.Thing embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary,
          </p>
        </blockquote>
      </div>
    </div>
        ...
        <div class="w-full md:w-6/12 sm:px-4 md:px-0 lg:px-1">
          <div class="relative flex flex-col mt-4">
            <div class="px-4 py-5 flex-auto">
              ...
              <h6 class="text-xl sm:text-lg mb-1 font-semibold"> Education Help</h6>
              <p class="mb-4 text-sm md:text-lg font-light text-gray-600">
              Education Help.What we do for the poor people and the children
              </p>
            </div>
            <div class="px-4 py-5 flex-auto">
          ...
          <div class="relative flex flex-col min-w-0">
            <div class="px-4 py-5 flex-auto">
              ...
              <p class="mb-4 text-sm md:text-lg font-light text-gray-600">
              Madical Treatment Help To provide financial assistance for the well-being of poor people
              </p>
            </div>
          </div>
        </div>
        <div class="w-full md:w-6/12 px-4">
          <div class="relative flex flex-col min-w-0 mt-4">
            <div class="px-4 py-5 flex-auto">
              ...
              <p class="mb-4 text-sm md:text-lg font-light text-gray-600">
              Provide financial assistance for the provision of tubes for pure water
              </p>
            </div>
            <div class="px-4 py-5 flex-auto">
              <div class="text-blueGray-500 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-blue-50">
