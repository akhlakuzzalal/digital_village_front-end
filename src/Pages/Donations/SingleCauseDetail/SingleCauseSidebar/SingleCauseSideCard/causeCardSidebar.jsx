  ...
  return (
    ...
    >
      ...
      <div class="flex-grow p-3">
        <div class="font-semibold text-gray-700 dark:text-dark_text hover:dark:text-gray-700">
          {title}
        </div>
        <div class="text-sm text-gray-500 dark:text-gray-300 hover:dark:text-gray-500">
          {category}
        </div>
      </div>
      <div class="p-2">
