...
//                         <input class=" p-4 w-full  mb-4 shadow-2xl"
...
//                    </div>
//                    <div class="mr-2 pl-10">
//                        <input class="p-4 w-full  mb-4 shadow-2xl" type="number"
...
//                    </div>
//                    <div class="mr-2 pl-10 ">
//                        <input class="w-full  p-4 mb-4 shadow-2xl"  type="email"
//                         {...register("email")} placeholder='Enter Your Email Number'
//                         required
//                          />
//                     </div>
//                    <div class="mr-2 pl-10 ">
//                        <input class="w-full p-4 mb-4 shadow-2xl"  type="text"
//                         {...register("subject")} placeholder='Write your Subject'
//                         required
//                          />
//                     </div>
//                     <div class=" col-span-2 mx-6 ">
//                          <textarea placeholder='Please Write Your Message' class=" w-full ml-5 p-4 mb-2 shadow-2xl" 
//                          {...register("message", { required: true, maxLength: 20 })}
//                          type="message"
//                           />
//                     </div>
                    
//                     <input class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500 btn mx-auto col-span-2 font-bold rounded-lg  px-6 md:w-2/6  py-2 text-white" type="submit"value="Send Message"/>
//                 </form>
//             </div>
//         </div>
//     );
