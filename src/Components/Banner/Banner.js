...
const Banner = () => {
    return (
        <div className='container mx-auto bg-gray-50 rounded'>
            <h5 className='text-5xl font-bold text-red-700 py-5'>This is Banner Page</h5>
            <div className='grid grid-cols-2'>
                <div className='my-8'>
                    ...
                    <button className='rounded-none bg-blue-600 p-2 text-white rounded my-2'>Explore More</button>
                </div>
                <div>
